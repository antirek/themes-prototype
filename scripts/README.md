...
Мощный скрипт для комплексной валидации системы тем компонентов. Выполняет **4 типа проверок**:
...
8. **Отчет**: Выводит результаты всех четырех проверок
...
📋 Проверяю компонент: CardPreview
   ...
   ✅ starwars: интерфейс OK, префиксы OK, глобальные переменные OK
   ✅ light: интерфейс OK, префиксы OK, глобальные переменные OK
   ✅ green: интерфейс OK, префиксы OK, глобальные переменные OK
   ✅ dark: интерфейс OK, префиксы OK, глобальные переменные OK
   ✅ avatar: интерфейс OK, префиксы OK, глобальные переменные OK
...
📊 Итоговая статистика:
   Всего проверено: 15 тем (4 проверки на тему)
   ✅ Валидных проверок: 46
...
- **15 тем** проверено (4 компонента × 3 темы + 3 глобальных темы)
- **46 валидных проверки** (4 проверки на тему)
