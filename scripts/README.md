...
📊 Итоговая статистика:
   Всего проверено: 25 тем (4 проверки на тему)
   ✅ Валидных проверок: 74
...
- **25 тем** проверено (4 компонента × 5 тем + 5 глобальных тем)
- **74 валидных проверки** (4 проверки на тему)
